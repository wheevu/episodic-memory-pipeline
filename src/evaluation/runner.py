    ...
    def run_scenario(
        ...
        try:
            ...
            ingestion = IngestionPipeline(
                ...
                self.embedding_provider, self.llm,
            ...
            consolidation_results = consolidation.consolidate_all()
            ...
            for query in scenario.get_queries():
                ...
                expected_ids = [
                    ep_id for ep_id, topics in episode_topic_map.items()
            ...
            compression_result = self.compression_metric.evaluate(
