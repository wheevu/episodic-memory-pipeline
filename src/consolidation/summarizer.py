...
class Summarizer:
    ...
    def summarize(
        ...
        try:
            ...
            summary_content = as_str(result.get("summary"), default="Summary generation failed.") or "Summary generation failed."
...
{{
    ...
    "overall_themes": ["Major recurring themes"]
        ...
        try:
            ...
            summary_content = as_str(result.get("summary"), default="Higher-level summary generation failed.") or "Higher-level summary generation failed."
