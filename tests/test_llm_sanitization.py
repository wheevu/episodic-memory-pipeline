...
from src.models import Episode, MemoryType, Fact, FactCategory, Summary
...
class TestSummaryModelIntegration:
    ...
    def test_summary_with_nulls_sanitized(self) -> None:
        ...
        content = as_str(llm_response.get("summary"), default="Summary unavailable") or "Summary unavailable"
